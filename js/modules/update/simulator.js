...
export class UpdateSimulator {
    ...
    getOsIcon(id) {
        ...
        if (id === 'win10' || id === 'win11') return this.windowsSVG;
    ...
    buildWindows11UI(os) {
        ...
        this.simulationArea.innerHTML = `
            <div class="update-content win11-layout">
                <div class="win11-logo">${this.windowsSVG}</div>
